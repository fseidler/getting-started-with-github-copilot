...
activities = {
    ...
    "Basketball Club": {
        "description": "Basketball drills, teamwork, and games",
    ...
    "Mathletes": {
        "description": "Problem-solving practice and math competitions",
        "schedule": "Fridays, 2:30 PM - 4:00 PM",
        "max_participants": 15,
        "participants": []
    },
    "Science Club": {
        "description": "Hands-on experiments and science fair prep",
